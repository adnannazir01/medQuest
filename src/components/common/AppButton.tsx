...
import {normalizeFont, normalizeHeight, normalizeWidth, pixelSizeY} from '../../theme/size';
...
export default function AppButton(props: appBtnType): JSX.Element {
  ...
  return (
    <TouchableOpacity
      ...
      {title && (
        <AppText
          style={[{fontSize: normalizeFont(14), fontWeight: '500', lineHeight: 18}, textStyle]}
          numberOfLines={1}
          presetStyle={'button'}
          transText={title}
